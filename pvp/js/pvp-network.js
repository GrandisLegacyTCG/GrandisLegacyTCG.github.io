/* Grandis Legacy PvP v3.45 server/lobby integration controller.
...
(function(){
  'use strict';
  var VERSION='Grandis Legacy PvP v3.45 · Northflank Server Boot Fix + Lobby Style 1 Controls · OSA v1.9.5 · 2 Players + 4 Spectators';
  ...
  var CLIENT_BUILD_ID=String(DEPLOY_CONFIG.buildId||'gl-pvp-3.45-server-lobby-fix-2026-09-24');
