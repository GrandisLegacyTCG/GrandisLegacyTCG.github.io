/* Grandis Legacy PvP v2.6.11 network adapter.
   Two fixed Northflank services share one repository. Lobby v0.5 is productionized; battlefield consumes the VS AI v5.55 UI/runtime contract. */
(function(){
  'use strict';
  var VERSION='Grandis Legacy PvP v2.6.20 · VS AI v5.61 battlefield · Lobby Design Lock v0.5 · 2 Players + 4 Spectators';
  ...
  function deckBuilderUrl(){return DEPLOY_CONFIG.deckBuilderUrl||'https://grandislegacytcg.github.io/Grandis-Legacy-Deck-Builder/';}
  ...
  var COIN_HEAD_SRC='assets/cards/ui/Racial-Token-Head.webp?v=gl-pvp-2.6.10';
  var COIN_TAIL_SRC='assets/cards/ui/Racial-Token-Tail.webp?v=gl-pvp-2.6.10';
...
.pvp-v260-page{min-height:100vh;padding:20px 42px 42px}.pvp-v260-topbar{min-height:58px;display:grid;grid-template-columns:194px minmax(280px,1fr) auto;align-items:start;gap:20px;margin-bottom:12px}.pvp-v260-logo{display:block;width:190px;height:58px;overflow:hidden;text-decoration:none;cursor:pointer;border-radius:8px}.pvp-v260-logo:focus-visible{outline:2px solid var(--pvp-gold);outline-offset:3px}.pvp-v260-logo img{width:100%;height:100%;object-fit:contain;object-position:left center;filter:drop-shadow(0 3px 8px rgba(0,0,0,.38))}.pvp-v260-heading{padding-top:6px}.pvp-v260-heading h1{margin:0;font-size:17px;line-height:1;font-weight:900;letter-spacing:.02em}.pvp-v260-heading p{margin:7px 0 0;color:#989ca4;font-size:13px;font-weight:500}.pvp-v260-top-actions{display:flex;gap:10px;padding-top:4px}
...
.pvp-game-result-summary{min-width:min(440px,78vw)!important}.pvp-game-result-actions{display:grid!important;grid-template-columns:1fr!important;gap:10px!important;margin-top:4px!important}
