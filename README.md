...
The `/pvp/` directory is the exact byte-for-byte mirror of the final Grandis Legacy PvP v3.44 `public/` frontend. External real-network verification remains pending deployment-environment acceptance.

See `release/WEBSITE_v1.33_RELEASE_NOTES.md` and `release/PVP_v3.44_WEBSITE_MIRROR_AUDIT.md`.
