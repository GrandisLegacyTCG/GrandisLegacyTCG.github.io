...
Deployable GitHub Pages package for the Grandis Legacy public website, Rulebook/General Arvon experience, and embedded PvP v3.07 client.

## v1.8 Source Stack hotfix adoption
...
- Embeds the PvP v3.07 public client while preserving hidden-information, seat authority, and read-only spectator behavior.
