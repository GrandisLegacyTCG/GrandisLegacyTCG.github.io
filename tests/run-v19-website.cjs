...
assert.strictEqual(require('../package.json').version, '1.9.0');
...
assert.ok(read('pvp/index.html').includes('gl-pvp-3.08'), 'Embedded public PvP package is not v3.08.');
...
console.log('PASS Website v1.9: 198 canonical physical artworks, all 30 revised cards, Back Slash, renamed audio, multilingual Arvon, Rulebook v2, v1.7 homepage layout, PvP v3.08 embed, and source lock.');
