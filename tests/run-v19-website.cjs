...
assert.ok(read('pvp/index.html').includes('gl-pvp-3.16'), 'Embedded public PvP package is not v3.09.');
...
console.log('PASS Website v1.16: 198 canonical physical artworks, all 30 revised cards, Back Slash, renamed audio, multilingual Arvon, Rulebook v2, v1.7 homepage layout, PvP v3.16 embed, and source lock.');
