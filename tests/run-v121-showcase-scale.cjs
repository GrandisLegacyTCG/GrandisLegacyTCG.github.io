...
assert(html.includes('assets/site/Cards.png?v=1.21.0'),'Cards.png cache bust missing');
...
assert(/\.hero-card-showcase\{[^}]*transform:scale\(1\.6\)/.test(siteCss),'Cards.png showcase scale restoration missing');
