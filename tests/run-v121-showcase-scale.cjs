...
assert(html.includes('css/site.css?v=1.21.0'),'site CSS cache bust missing');
assert(html.includes('assets/site/Cards.png?v=1.21.2'),'Cards.png cache bust missing');
...
assert(pvpHtml.includes('maximum-scale=1')&&pvpHtml.includes('user-scalable=no')&&pvpHtml.includes('../assets/site/favicon.png?v=1.20'));
...
console.log('PASS Website v1.21 Cards.png visual scale restored + v1.20 update preserved');
