...
assert(app.includes("e.reason==='MANDATORY_DRAW_PHASE'")&&app.includes('window.scrollBy(0,overlap)'));assert.strictEqual(require('../package.json').version,'1.22.0');
console.log('PASS Website v1.22 embedded PvP Mobile UI HF2');
