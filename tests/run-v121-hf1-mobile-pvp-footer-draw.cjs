...
assert(pvp.includes('gl-pvp-3.40-playtest-v014'));assert(pvp.includes('assets/favicon.png?v=3.23'));
...
assert(app.includes("e.reason==='MANDATORY_DRAW_PHASE'")&&app.includes('window.scrollBy(0,overlap)'));assert.strictEqual(require('../package.json').version,'1.29.0');
console.log('PASS Website v1.29 embedded PvP Mobile UI HF2');
