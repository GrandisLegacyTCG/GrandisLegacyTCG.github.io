...
assert(pvp.includes('gl-pvp-3.35-production-frontend-sync'));assert(pvp.includes('assets/favicon.png?v=3.23'));
...
assert(app.includes("e.reason==='MANDATORY_DRAW_PHASE'")&&app.includes('window.scrollBy(0,overlap)'));assert.strictEqual(require('../package.json').version,'1.24.0');
console.log('PASS Website v1.24 embedded PvP Mobile UI HF2');
