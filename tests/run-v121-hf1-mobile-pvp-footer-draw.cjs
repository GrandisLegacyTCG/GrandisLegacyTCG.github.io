...
assert(pvp.includes('gl-pvp-3.37-mobile-action-popup'));assert(pvp.includes('assets/favicon.png?v=3.23'));
...
assert(app.includes("e.reason==='MANDATORY_DRAW_PHASE'")&&app.includes('window.scrollBy(0,overlap)'));assert.strictEqual(require('../package.json').version,'1.26.0');
console.log('PASS Website v1.26 embedded PvP Mobile UI HF2');
