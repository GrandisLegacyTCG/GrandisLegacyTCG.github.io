...
assert(pvp.includes('gl-pvp-3.22-parity-fixes'));assert(pvp.includes('../assets/site/favicon.png?v=1.22'));
...
assert(app.includes("e.reason==='MANDATORY_DRAW_PHASE'")&&app.includes('window.scrollBy(0,overlap)'));assert.strictEqual(require('../package.json').version,'1.23.0');
console.log('PASS Website v1.23 embedded PvP Mobile UI HF2');
