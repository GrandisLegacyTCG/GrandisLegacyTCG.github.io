...
assert(html.includes('gl-pvp-3.22-parity-fixes'),'embedded PvP cache revision is not v3.14');
assert(html.includes('glMobileAppMenuButton')&&html.includes('glMobileAppMenu'),'embedded PvP hamburger DOM missing');
assert(html.includes('js/mobile-app-nav.js?v=gl-pvp-3.22-parity-fixes'),'embedded mobile navigation controller not loaded');
...
assert(app.includes('Grandis Legacy PvP v3.22')&&app.includes('VS AI v6.24'),'embedded shared gameplay marker stale');
