...
assert(html.includes('gl-pvp-3.18'),'embedded PvP cache revision is not v3.14');
assert(html.includes('glMobileAppMenuButton')&&html.includes('glMobileAppMenu'),'embedded PvP hamburger DOM missing');
assert(html.includes('js/mobile-app-nav.js?v=gl-pvp-3.18'),'embedded mobile navigation controller not loaded');
...
assert(app.includes('Grandis Legacy PvP v3.18')&&app.includes('VS AI v6.21'),'embedded shared gameplay marker stale');
...
console.log('PASS Website v1.18 embedded PvP v3.18 sync: canonical Defense, result reload, right-edge hamburger, production config preserved.');
