...
assert(html.includes('gl-pvp-3.20-mobile-hf1'),'embedded PvP cache revision is not v3.14');
assert(html.includes('glMobileAppMenuButton')&&html.includes('glMobileAppMenu'),'embedded PvP hamburger DOM missing');
assert(html.includes('js/mobile-app-nav.js?v=gl-pvp-3.20-mobile-hf1'),'embedded mobile navigation controller not loaded');
...
console.log('PASS Website v1.21 embedded PvP v3.20 sync: canonical Defense, result reload, right-edge hamburger, production config preserved.');
